...
```
  ./installOpenObserveGoFlow.sh -useremail rootuser@example.com -userpassword ComplexPassword123421 -goflowhttpauth cmVwbGFjZW1lQGV4YW1wbGUuY29tOkNvbXBsZXhwYXNzIzEyMzQ1Ng== -installdir ~/OpenObserve
```
